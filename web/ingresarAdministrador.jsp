<%-- 
    Document   : ingresarAdministrador
    Created on : Nov 19, 2016, 3:19:16 PM
    Author     : Estefi
--%>
...
<html>
    ...
    <body class="fixed-sn mdb-skin">
        ...
        <!--Main layout-->
        <main>
            <h5 class="title">Ingresa como administrador</h5>
            <br>
            <%@ page import="business.DBHandler" %>
    
            <% if (DBHandler.usuarioValido == false) { %>
            <p style="color:red">El usuario o la contrase&ntilde;a estan incorrectos</p>
            <% }%>
            <br>
            <form action="login.jsp" method="post">
                    ...
                    <br><br><br>
                    <input class="active btn btn-primary btn-lg waves-effect waves-light" type=submit value="Ingresar">
            </form>
        </main>
        <!--/Main layout-->
